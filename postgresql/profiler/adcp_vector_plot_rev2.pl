...
#              multi_obs.m_date>=(timestamp '$date' - interval '$env{time_interval} hours')));";
  ...
  for my $strDate ( sort (keys %Hoh) ) 
  {
    ...
    my %BinDepths = %$refBinDepth;
		...
		open(OUTPUT_1,">c://temp/adcp//adcp_data_file1_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_2,">c://temp/adcp//adcp_data_file2_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_3,">c://temp/adcp//adcp_data_file3_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_4,">c://temp/adcp//adcp_data_file4_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_5,">c://temp/adcp//adcp_data_file5_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_6,">c://temp/adcp//adcp_data_file6_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_7,">c://temp/adcp//adcp_data_file7_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_8,">c://temp/adcp//adcp_data_file8_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_9,">c://temp/adcp//adcp_data_file9_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_10,">c://temp/adcp//adcp_data_file10_$process_id.txt") or die "Unable to open file: $!";
		open(OUTPUT_11,">c://temp/adcp//adcp_data_file11_$process_id.txt") or die "Unable to open file: $!";		
